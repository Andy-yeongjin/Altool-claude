...
This repository is licensed under the MIT License for original Altool
materials. The following bundled or referenced third-party materials are not
relicensed by Altool. They remain subject to their original owners'
licenses, terms, or public-use policies.

## Vercel React Best Practices skill

- Included path: `templates/claude/skills/vercel-react-best-practices/ (and installed to .claude/skills/vercel-react-best-practices/)`
...
GitHub, Vercel, Neon, Anthropic, Claude, Next.js, React, and other product or
